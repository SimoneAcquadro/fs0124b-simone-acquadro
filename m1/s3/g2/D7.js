...
*/
let string1 = 'Simone';
let string2 = 'Acquadro';

function concatena(string1, string2) {

  let primiDueCaratteri = string1.substring(0,2);
  let ultimiTreCaratteri = string2.slice(-3);
...
let arrayNumerico = [5, 10, 15, 20]
let result = arrayNumerico.filter(pari)

function pari(numeriPari) {
  return numeriPari % 0;
}
console.log(result);
